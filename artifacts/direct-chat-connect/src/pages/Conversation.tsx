        ...
        <div className="px-2 md:px-3 py-3 space-y-0 max-w-3xl mx-auto">
          ...
          {groupedMessages.map(({ msg, isFirst, isLast }) => (
            <div key={`${msg.id}`} className="relative">
              ...
              />
              {uploadingId === msg.id && (
                <div className={cn('flex items-center gap-1 text-[10px] text-muted-foreground mt-0.5', msg.sender === 'Agent' || msg.sender === 'User' ? 'justify-end pr-10' : 'justify-start pl-10')}>
